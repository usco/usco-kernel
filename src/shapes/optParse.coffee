...
module.exports.parseOptionAs3DVector = parseOptionAs3DVector
...
module.exports.interpolateBetween2DPointsForY = interpolateBetween2DPointsForY
module.exports.reTesselateCoplanarPolygons = reTesselateCoplanarPolygons

#very likely NOT needed, at least in current form
module.exports.FuzzyFactory = FuzzyFactory
module.exports.FuzzyCSGFactory = FuzzyCSGFactory
module.exports.FuzzyCAGFactory = FuzzyCAGFactory
